...
public class NPCFormationManager : MonoBehaviour
{
    ...
    [Header("References")]
    public Transform playerTransform; // Reference to the player
    public Transform targetLocation; // Custom location for formations
    ...
    private Vector3 formationOriginPosition; // Position where the formation was created
    private Quaternion formationOriginRotation; // Rotation at formation creation
    private bool useCustomLocation = false; // Flag to use targetLocation instead of formationOrigin
    ...
    // New method to set a custom location for formation
