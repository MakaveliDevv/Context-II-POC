...
public class Test2 : MonoBehaviour
{
    ...
    [SerializeField] private GameObject locationObject; // The plane object representing the location
    ...
    private void UpdateLocationBoundaries()
    {
        if (locationObject != null)
        {
            // Get the Collider of the locationObject
            Collider locationCollider = locationObject.GetComponent<Collider>();
